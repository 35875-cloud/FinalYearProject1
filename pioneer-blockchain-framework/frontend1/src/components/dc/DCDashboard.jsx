...
const DC_NAV_LINKS = [
  { to: '/dc/dashboard', icon: 'fas fa-scale-balanced', label: 'DC Dashboard' },
...
const DCDashboard = () => {
  ...
  return (
    <OfficerLayout title="DC Dashboard" roleLabel="DC" roleSubtitle="Deputy Commissioner" navLinks={DC_NAV_LINKS}>
