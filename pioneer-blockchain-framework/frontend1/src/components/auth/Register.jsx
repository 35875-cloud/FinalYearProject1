...
const Register = () => {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    const { role, cnic, fatherCnic, name, fatherName, mobile, email, password, confirmPassword, termsAccepted } = formData;
    ...
    const data = { role, cnic: cc, fatherCnic: cfc, name, fatherName, mobile, email, password };
    setTempUser(data);
          ...
          <div className="auth-card-header">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
              <div>
                ...
                <p className="auth-card-subtitle">Register to access the Blockchain Land Registry System.</p>
              </div>
