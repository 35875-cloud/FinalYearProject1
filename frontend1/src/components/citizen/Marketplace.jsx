        ...
        <label style={{ display: 'block', marginBottom: 20 }}>
          ...
          <textarea
            ...
            style={{
              ...
              padding: '11px 13px', fontFamily: "'Plus Jakarta Sans', 'DM Sans', system-ui, sans-serif", fontSize: '.9rem',
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
          <button
            ...
            style={{
              ...
              cursor: loading ? 'not-allowed' : 'pointer', fontFamily: "'Plus Jakarta Sans', 'DM Sans', system-ui, sans-serif",
            }}
          >
            Cancel
          </button>
        ...
        {listing.is_own ? (
          ...
          <button
            ...
            style={{
              ...
              fontFamily: "'Plus Jakarta Sans', 'DM Sans', system-ui, sans-serif", opacity: busy === listing.property_id ? 0.7 : 1,
...
const PropertyMarketplace = () => {
  ...
  const loadListings = useCallback(async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        showToast(data.message || 'Failed to load listings', 'error');
        setListings([]);
      }
    } catch (err) {
      console.error(err);
      showToast('Network error — could not load listings', 'error');
    } finally {
      setLoading(false);
    }
  ...
  const selectStyle = {
    ...
    background: '#fff', color: T.text, fontSize: '.88rem', fontFamily: "'Plus Jakarta Sans', 'DM Sans', system-ui, sans-serif",
    cursor: 'pointer', outline: 'none', minWidth: 140,
  };

  return (
    <CitizenLayout title="Marketplace">
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              ...
              <div>
                <p style={{ margin: 0, fontSize: '.72rem', fontWeight: 700, color: T.muted, textTransform: 'uppercase', letterSpacing: '.1em', fontFamily: "'Plus Jakarta Sans', 'DM Sans', system-ui, sans-serif" }}>
                  Citizen Marketplace
                </p>
                <h1 style={{ margin: '4px 0 0', fontSize: '1.55rem', fontWeight: 800, color: T.text, lineHeight: 1.1, letterSpacing: '-.02em', fontFamily: "'Plus Jakarta Sans', 'DM Sans', system-ui, sans-serif" }}>
                  Marketplace
                </h1>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
              ...
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer', fontFamily: "'Plus Jakarta Sans', 'DM Sans', system-ui, sans-serif",
                }}
              >
          ...
          >
            ...
            <div style={{ position: 'relative', flex: '1 1 260px', minWidth: 220 }}>
              ...
              <input
                ...
                style={{
                  ...
                  fontFamily: "'Plus Jakarta Sans', 'DM Sans', system-ui, sans-serif", outline: 'none', boxSizing: 'border-box',
                }}
              />
              {search && (
                <button
            ...
            <button
              ...
              style={{
                ...
                padding: '9px 20px', borderRadius: 10, border: 'none',
                background: T.primary, color: '#fff',
                fontSize: '.88rem', fontWeight: 700, cursor: 'pointer', fontFamily: "'Plus Jakarta Sans', 'DM Sans', system-ui, sans-serif",
              }}
            >
