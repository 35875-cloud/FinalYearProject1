...
const downloadTransferCaseSheet = (record) => {
  if (!record) return;
...
<head>
  <meta charset="UTF-8" />
  <title>Transfer Case Sheet - ${record.transfer_id}</title>
  <style>
...
<body>
  <div class="card">
    <div class="head">
      <h1>Transfer Case Sheet</h1>
      <p>5-node LRO transfer voting review snapshot</p>
    </div>
    <div class="body">
      <div class="grid">
        <div class="box"><div class="label">Transfer ID</div><div class="value">${record.transfer_id}</div></div>
        <div class="box"><div class="label">Property ID</div><div class="value">${record.property_id}</div></div>
        <div class="box"><div class="label">Seller</div><div class="value">${record.seller_name || 'N/A'}</div></div>
        <div class="box"><div class="label">Buyer</div><div class="value">${record.buyer_name || 'N/A'}</div></div>
                ...
                <div style={{ display: 'grid', gap: '1rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '.75rem', flexWrap: 'wrap' }}>
                      {/* <button
                        onClick={() => downloadTransferCaseSheet(selectedRecord)}
                        style={{
                          border: 'none',
                          borderRadius: 12,
                          padding: '10px 14px',
